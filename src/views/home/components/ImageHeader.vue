...
<div class="text-current text-4xl pt-2 pb-2">
Start
</div><div class="text-current pb-2">
...
</div><div class="text-current text-4xl pb-2">
First visit
</div><div class="text-current pb-2">
...
<div class="flex flex-row flex-wrap">
      ...
      <img
        loading="lazy"
        class="md:py-24 py-2 mx-auto md:w-5/12"
        :src="France"
        alt="Kirk Lin"
        title="hi there"
      /> 
      ...
      <img
        loading="lazy"
        class="md:pb-24 pb-4 mx-auto md:w-5/12"
        :src="France"
        alt="Kirk Lin"
        title="hi there"
      /> 
...
</div><div class="text-current pb-2 text-4xl">
...
import france from "~/assets/frankrijk.jpg";
const France = france;
